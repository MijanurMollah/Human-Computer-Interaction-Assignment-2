...
Partial Class AboutBox1
    ...
    Private Sub InitializeComponent()
        ...
        Me.LabelCompanyName.Text = "Md Mijanur Mollah - 500706130"
        ...
        Me.TextBoxDescription.Text = "Modifying the MDI for specific functionality"
        '
        'OKButton
        '
